...
export function CreateEvent() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Salva detalhes extras no localStorage (imagem, descrição, data, etc.)
      const extras = JSON.parse(localStorage.getItem("evenza_eventos") || "{}");
      extras[saved.id ?? titulo] = { titulo, descricao, data, horario, localizacao, site, categorias, acessibilidade, inscricao, imagem };
